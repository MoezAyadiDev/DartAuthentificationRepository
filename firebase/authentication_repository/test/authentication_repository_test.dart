...
void main() {
  ...
  group('AuthenticationRepository', () {
    ...
    group('logOut', () {
      final Map<String, bool> isSignedInWith = {
        'emailPassword': false,
        'google': false,
      };
      test('calls signOut with Email', () async {
        isSignedInWith['emailPassword'] = true;
        authenticationRepository.isSignedInWith = isSignedInWith;
      ...
      test('calls signOut with google', () async {
